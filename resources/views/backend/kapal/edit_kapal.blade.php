...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Edit Kapal</h6>
        </div>
        <div class="card-body">
            <form method="post" action="{{ route('kapal.update', $kapal->id) }}">
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="nm_kapal" value="{{ $kapal->nm_kapal }}">
                    </div>
                </div>
                <div class="form-group row mb-4">
                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Kapasitas : </label>
                    <div class="col-sm-12 col-md-7">
                        <input type="text" class="form-control" name="kapasitas" value="{{ $kapal->kapasitas }}">
                    </div>
                </div>
                <div class="form-group row mb-4">
